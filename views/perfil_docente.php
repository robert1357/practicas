    ...
    <header class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                <a href="docente_dashboard.php" class="text-principal hover:text-emerald-700 transition">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="grado_academico" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-principal" required>
                                        ...
                                        <option value="licenciado" <?php echo ($currentUser['grado_academico'] == 'licenciado') ? 'selected' : ''; ?>>Licenciado/Título Profesional</option>
                                        <option value="maestria" <?php echo ($currentUser['grado_academico'] == 'maestria') ? 'selected' : ''; ?>>Maestría</option>
                                        <option value="doctorado" <?php echo ($currentUser['grado_academico'] == 'doctorado') ? 'selected' : ''; ?>>Doctorado</option>
                                    </select>
                                </div>
