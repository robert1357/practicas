...
$userModel = new User();
$estudiante = $userModel->getById($reporte['estudiante_id']);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body class="bg-gray-50 min-h-screen">
    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            <a href="coordinador_reportes.php?estudiante=<?php echo $reporte['estudiante_id']; ?>" class="text-xl font-bold text-gray-800 flex items-center gap-2">
            ...
            <div class="p-6">
                <div class="grid lg:grid-cols-3 gap-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p><strong>Estado:</strong> 
                                        <span class="px-2 py-1 rounded text-xs font-medium <?php echo $reporte['estado'] == 'pendiente' ? 'bg-yellow-100 text-yellow-800' : ($reporte['estado'] == 'calificado' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            <a href="coordinador_reportes.php?estudiante=<?php echo $reporte['estudiante_id']; ?>" 
                            ...
                            <a href="coordinador_dashboard.php" 
